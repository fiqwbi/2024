...
const DIALOGS: ILevelDialog[] = [
	{
		...
		answers: ['annisa', 'anisa', 'annisa kamila', 'kamila',],
		hint: '(?) This game is made for my girl'
	},
	{
		question:
			'Who regrets all of their actions and asks for a chance?<br>' +
	...
	{
		question: 'How much love should I give you for you to believe that I truly regret it?',
		answers: [],
		type: 'number'
	}
];
